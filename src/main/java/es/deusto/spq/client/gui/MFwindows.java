...
public class MFwindows extends JFrame implements Runnable {
	...
	private void initComponents() throws RemoteException {
		...
		ImageIcon playicon = new ImageIcon(classloader.getResource("images/p1.png"));
		ImageIcon favoriteicon = new ImageIcon(classloader.getResource("images/d.png"));
		ImageIcon pauseicon = new ImageIcon(classloader.getResource("images/s1.png"));
		ImageIcon addicon = new ImageIcon(classloader.getResource("images/a.png"));
		ImageIcon editicon = new ImageIcon(classloader.getResource("images/e.png"));
